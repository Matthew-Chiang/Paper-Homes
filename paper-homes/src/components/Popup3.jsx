      ...
      >
        ...
        <div className={classes.main}>
          <DialogTitle id="max-width-dialog-title">
            ...
            Let's get you an ID Card.
            </h1>
          </DialogTitle>
          <DialogContent>
          <DialogContentText>
          We’ve filled out the forms you need for you with your information. Print these forms out* and give them your nearest homeless service provider to apply for your California ID Card!          </DialogContentText>
