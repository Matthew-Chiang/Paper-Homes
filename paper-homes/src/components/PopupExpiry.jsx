        ...
        Open max-width dialog
            ...
            >
                ...
                <div className={classes.main}>
                    ...
                    <DialogContent>
                        <DialogContentText>
                            Every 6 months, we'll check to see if you still need
                            your address. Let us know if you no longer need this
                            address or if you would like to renew it.
                        </DialogContentText>
                        ...
                        <DialogActions>
                            <div className={classes.buttonWrap}>
                                <Button
                                    variant="contained"
                                    className={classes.expiryButtons}
                                    onClick={handleClose}
                                >
                                    Let it expire
                                </Button>
